...
### Этап 9.5: Оптимизация классификации
- [ ] 9.5.1 Оптимизация памяти (4Гб для Landsat - слишком много)
- [ ] 9.5.2 Использование KD-tree для Multivariate KDE
- [ ] 9.5.3 Выбор оптимального k соседей
