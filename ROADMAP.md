...
### Этап 9.5: Оптимизация классификации (ОТЛОЖЕНО)
- [ ] 9.5.1 Оптимизация памяти (4Гб для Landsat - слишком много) — отложено
- [ ] 9.5.2 Использование KD-tree для Multivariate KDE — отложено
